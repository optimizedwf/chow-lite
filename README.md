...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-598%20passing%2C%205%20skipped%20(603%20collected)-brightgreen" alt="tests">
...
tests/                    603 tests (router, ledger, gates, executor, chains, learn, ADK, doc-truth)
```

## Roadmap

- [x] Core loop (router → workflow → gate → ledger) with 598 passing tests (603 collected, 5 live-gated skips)
