...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-617%20passing%2C%205%20skipped%20(622%20collected)-brightgreen" alt="tests">
...
tests/                    622 tests (router, ledger, gates, executor, chains, learn, ADK, doc-truth)
```

## Roadmap

- [x] Core loop (router → workflow → gate → ledger) with 617 passing tests (622 collected, 5 live-gated skips)
