...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-602%20passing%2C%205%20skipped%20(607%20collected)-brightgreen" alt="tests">
...
tests/                    607 tests (router, ledger, gates, executor, chains, learn, ADK, doc-truth)
```

## Roadmap

- [x] Core loop (router → workflow → gate → ledger) with 602 passing tests (607 collected, 5 live-gated skips)
