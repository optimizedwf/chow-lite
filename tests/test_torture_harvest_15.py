...
def test_t29_f6_doc_counts_track_actual_suite():
    """README/SUBMISSION must claim the CURRENT suite size (573 passing /
    578 collected), never the pre-doc-truth 568/573."""
    ...
    for doc in (_readme(), _submission()):
        ...
        assert "583/588" in doc or "583 tests (588" in doc or \
               "583%20passing" in doc, "current counts missing"
