...
managed with the same route→execute→verify→learn loop. 598/603 tests pass (603 collected, 5 live-gated skips);
...
| Demo & Production Readiness (30%) | one-command demo, 598 tests (603 collected), Dockerfile + deploy.sh, FastAPI operator API, model-or-fail (no fabricated output) |
